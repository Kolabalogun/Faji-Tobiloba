...
import NewProject from "../News/NewProject";
      ...
      {loader ? (
        ...
        <>
          {state ? (
              ...
              <div className="grid xl:grid-cols-4  lg:grid-cols-3 grid-cols-2 gap-4 my-5 mx-3">
                <div className="flex flex-col">
                  ...
                  <div className="p-1 py-6 flex flex-col">
                    <h5 className="font-semibold text-[#344767]">Project 1</h5>

                    <p className="py-4 text-[13px]">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Molestias consequatur animi placeat quos fuga non
                      voluptate, quo atque beatae vitae.
                    </p>

                    <div className="flex justify-between">
                      <button className="py-1 px-2 text-[13px] font-semibold  ">
                        EDIT PROJECT
                      </button>
                      <button className="py-1 px-2 text-[13px] font-semibold  bg-red-600 border-red-600 hover:text-red-500">
                        DELETE PROJECT
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="p-1 py-6 flex flex-col">
                    <h5 className="font-semibold text-[#344767]">Project 2</h5>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="p-1 py-6 flex flex-col">
                    <h5 className="font-semibold text-[#344767]">Project 3</h5>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="p-1 py-6 flex flex-col">
                    <h5 className="font-semibold text-[#344767]">Project 4</h5>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="p-1 py-6 flex flex-col">
                    <h5 className="font-semibold text-[#344767]">Project 5</h5>
            ...
            <NewProject handleState={handleState} />
          )}
        </>
      )}
    </div>
