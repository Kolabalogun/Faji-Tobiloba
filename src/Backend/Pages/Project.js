...
const Project = () => {
    ...
    return (
        <div className='bg-[#f5f6f7] w-full ml-[17%] min-h-[100vh] px-4 py-1 pb-4 h-full dashboard'>
            ...
            {state ? <div className="rounded py-4 px-6 h-[full] mt-4 w-full bg-white shadow-lg flex flex-col">
            ...
            ">
                ...
                <div className="grid xl:grid-cols-4  lg:grid-cols-3 grid-cols-2 gap-4 my-5 mx-3">
                    ...
                    <div onClick={handleState} className="flex flex-col border-dashed border-[3px] hover:opacity-60 bg-white cursor-pointer rounded-lg justify-center items-center">
            ...
            </div> : <NewProject handleState={handleState} />}
