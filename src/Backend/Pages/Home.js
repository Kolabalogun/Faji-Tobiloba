...
const Home = () => {
    const { user, navigate, loader, setloader } =
        useGlobalContext();
    ...
    return (
        <div className='bg-[#f5f6f7] w-full ml-[17%] min-h-[100vh] px-4 py-1 pb-4 h-full dashboard'>
            <Navbar />
            {loader ? <Loader /> : <div className="rounded py-4 px-6 h-[full] mt-4 w-full bg-white shadow-lg flex flex-col">
            ...
            ">
                ...
                <div className="m-3">
                    ...
                    <div className="flex  flex-col  my-[30px]  text-[14px]">
                        ...
                        <div className="grid grid-cols-1 gap-3 my-[10px]">
                            ...
                            <input type="text" name='title' value={title} onChange={handleChange} placeholder='Title' required className='border py-[18px] px-[25px] text-[14px] w-full' />

                        </div>

                        <div className="grid grid-cols-1 gap-3 my-[10px]">
                            <textarea placeholder='Caption' name='caption' value={caption} onChange={handleChange} required className='border py-[18px] px-[25px] text-[14px]  
                    '  rows="10" />
                ...
                <div className="mx-3">
                    ...
                    <div className="flex  flex-col  my-[10px]  text-[14px]">
                        ...
                        <button onClick={handleSubmit} className='text-[13px] bg-transparent m-auto my-5  flex justify-center items-center border-[2px] border-black px-[34px] py-[9px] text-black font-poppins w-[200px] hover:bg-black hover:text-white'>SAVE</button>
                    </div>
                </div>
