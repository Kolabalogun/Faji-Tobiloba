...
const Settings = () => {
  const { navigate, setloader, loader, notification, setuser } =
    useGlobalContext();
          ...
          <div className="w-full z-20  flex items-center justify-center">
            <div className="rounded py-4 px-6 h-full w-[50vh] bg-white shadow-lg  p-[90px] flex  z-1 flex-col  font-rubik text-center items-center justify-center">
              <div className=" justify-center  items-center flex-col flex py-3">
                <h1 className=" font-rubik text-[30px] font-bold bg-transparent z-30">
                  Sign Up
                </h1>

                <p className="text-black py-3 text-[14px] bg-transparent z-30">
                  Please enter Name, Email and Password to register user
                </p>
                <div className=" grid grid-cols-1 gap-6 bg-transparent z-30 my-[26px]">
                  <input
                    ...
                    required
                    className="w-[300px] border py-[10px]  px-[25px] text-[14px] outline-none  "
                  />
                  <input
                    onChange={handleChange}
                    type="text"
                ...
                <button
                  onClick={handleAuth}
                  className=" z-30 px-5 py-2 bg-black border-black text-white  hover:bg-white hover:text-black  "
                >
                  Sign Up
                </button>
              </div>
