...
const Dashboard = () => {
    return (
        <div className='bg-[#f5f6f7] w-full ml-[17%] min-h-[100vh] px-4 py-10 h-full dashboard'>
            <div className="rounded py-4 px-6 h-[full] w-full bg-white shadow-lg flex flex-col">
