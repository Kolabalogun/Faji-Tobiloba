...
const Sidebar = () => {
    ...
    return (
        <div className='adminSidebar lg:w-[17%]  w-[10%]'>
            ...
            <div className="menus ">
                ...
                <div onClick={() => {
                    pageStateF('story')
                }} className={pageState === 'story' ? 'activemenu eachmenu ' : 'eachmenu '} >
                    <img src="svg/message-solid.svg" alt="" />
                    <p>My Story</p>
                </div>
                <div onClick={() => {
                    pageStateF('article')
                }} className={pageState === 'article' ? 'activemenu eachmenu ' : 'eachmenu '} >
                    <img src="svg/blog.svg" alt="" />
                    <p>Articles</p>
                </div>
                <div onClick={() => {
                    pageStateF('message')
                }} className={pageState === 'message' ? 'activemenu eachmenu ' : 'eachmenu '} >
                    <img src="svg/msg.svg" alt="" />
                    <p>Messages</p>
                </div>
                <div onClick={() => {
                    pageStateF('project')
                }} className={pageState === 'project' ? 'activemenu eachmenu ' : 'eachmenu '} >
