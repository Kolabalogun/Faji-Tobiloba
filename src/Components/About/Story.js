                ...
                <div className="flex items-start">
                    ...
                    <div className=" flex flex-wrap w-[800px] ">
                        <p className='break-words text-white '>
                            ...
                            - First Special Assistant (Political Aide) in the history of Nigeria to attend FEC meetings after showing his capacity and competence as a key adviser. <br /> <br />
                            - First serving SU President to be awarded the national honour of Commander of the Order of the Nigeria (CON) 2022.  <br /> <br />
                            - President of the Year’ by This Day Newspapers 2022</p>
                    </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className=" flex flex-wrap w-[800px] ">
                        <p className='break-words text-white '>
                            ...
                            “Your Excellency, we commend your leadership as well as your unflinching commitment to the entire process that led to the passage of the University of Ilorinn Railway Corporation Act 1955 Repeal and Re-enactment Railway Bill, 2016. This definitely marks a very significant milestone in University of Ilorin’s history and further demonstrates the role of our legislature in the nation’s economic development.”  — University of Ilorin Economic Summit Group
                            <br />
                            <br />
                            “The President of the Senate Abubakar Bukola Saraki committed to ensure 1% of the Consolidated Revenue Fund is included in University of Ilorin’s budget to strengthen primary healthcare. Political will at all levels is needed for #HealthForAll” — WHO</p>
                    </div>
