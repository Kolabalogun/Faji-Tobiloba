            ...
            <div className="flex flex-col w-full mb-[60px] sm:mb-[30px]">
                ...
                <div className="border">
                    <div className=" p-[50px] sm-p-[20px]">
                        ...
                        <p className="mt-4 text-[11px] font-rubik
                        ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry industry’s standard dummy text Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text.</p>

                        <button className='bg-black border-black hover:bg-white hover:text-black text-white leading-5 text-[9px] px-[17px] py-1 uppercase rounded-[5px] mt-4 font-bold transition-colors delay-200 duration-300'>Continue Reading</button>
